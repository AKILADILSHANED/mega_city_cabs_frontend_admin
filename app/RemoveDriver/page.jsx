...
export default function DriverRemove() {
  ...
  const handleDriverRemove = async (e) => {
    e.preventDefault();
    try {
      const request = await fetch(
        `http://localhost:8080/api/v1/driver/driver-remove?driverId=${encodeURIComponent(
          driverIdText
        )}`,
        {
          method: "POST",
      ...
      if (request.ok) {
        ...
        setDeleteMessage("No response. Please contact administrator!");
      }
    } catch (error) {
      setDeleteMessage("An error occurred. Please contact administrator!");
    }
  };
            ...
            <div>
              ...
              <div className="mt-6 bg-white h-[190px] shadow-md hover:shadow-lg">
                ...
                <div className="flex flex-col items-center justify-center">
                  <input
                    className="mt-4 h-[30px] w-[200px] bg-red-400 text-white font-serif rounded-md shadow-md hover:bg-red-500"
                    type="submit"
                    value="Delete"
